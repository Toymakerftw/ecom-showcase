    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <header>
            ...
            <p class="mt-4 max-w-md text-gray-500">
                Discover our exclusive product collection, where you'll find a wide range of items tailored to you unique needs.
            </p>
        </header>
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<li>';
                echo '<a href="product_details.php?id=' . $productId . '" class="group block overflow-hidden">';
