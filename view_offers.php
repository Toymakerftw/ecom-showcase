...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_id'])) {
    ...
    $sql_delete = "DELETE FROM offers WHERE id = $delete_id";
...
// Fetch all images from the offers table
...
<head>
    ...
    <title>View offers Images</title>
...
<body>
    ...
    <div>
        <div class="grid min-h-[140px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
            <div role="alert" class="relative block w-full text-base font-regular px-4 py-4 rounded-lg bg-blue-100 text-white flex">
                <div class=" mr-12">
                    <p class="font-bold text-black">Don't add more than 5 images to offers as it would looks weird!
                    </p>
                </div>
            </div>
        </div>
    <div class="mx-auto max-w-screen-xl">
        <div class="container mx-auto py-8">
            <h1 class="text-3xl font-bold mb-6">offers Images</h1>
